...
Founding member and volunber director Noal Mehl has submitted an _Open Telecom Foundation endorse_ contribution to the Kazoo open source project that would greatly enhance Kazoo's ability to provide output of new realtime events. **EDR (Event Data Records)** would allow for a much more flexible and detailed method for Kazoo to provide output of a new types of realtime eventing. 
